...
def get_text_massages(message):
    ...
    if message.text == "🇷🇺 Русский":
        ...
        bot.send_message(message.from_user.id, "В Автозаводском районе можем преложить Вам пойти в следующие музей:\n\n🏛️ Музей истории ГАЗ: здесь Вы можете посмотреть на старые, но довольно известные машины, созданные раньше нашими инженерами строителями, которые вкладывали свою душу для создания этих легендарных машин. С более подробной информацией можете ознакомиться перейдя по [ссылке](https://museum.gaz.ru/)."
                                               "\n\n🏛️Музей Нижегородского метрополитена: здесь Вы можете ознакомиться как же строился и строится ВЕЛИКИЙ метрополитен Нижнего Новгорода. С более подробной информацией можете ознакомиться перейдя по [ссылке](http://metronn.ru/museum/)", reply_markup=markup, parse_mode='Markdown', disable_web_page_preview=True)
        ...
        bot.send_message(message.from_user.id,
                     "🥂 В Советском районе, к сожалению, нет клубов, но Вы можете потусить в любом другом районе Нижнего Новгорода из предложенного ниже списка.", reply_markup=markup)
        ...
        markup.add(btn1, btn2, btn3)
        bot.send_message(message.from_user.id,
                     "🥂 В Приокском районе, к сожалению, нет клубов, но Вы можете потусить в любом другом районе Нижнего Новгорода из предложенного ниже списка.", reply_markup=markup)
        ...
        markup.add(btn1, btn2, btn3)
        bot.send_message(message.from_user.id,
                     "🥂 В Сормовском районе, к сожалению, нет клубов, но Вы можете потусить в любом другом районе Нижнего Новгорода из предложенного ниже списка.",reply_markup=markup)
        ...
        markup.add(btn1, btn2, btn3)
        bot.send_message(message.from_user.id,
                     "🥂 В Московском районе, к сожалению, нет клубов, но Вы можете потусить в любом другом районе Нижнего Новгорода из предложенного ниже списка.", reply_markup=markup)

    elif message.text == "🥂 Канавинский":
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
        btn1 = types.KeyboardButton("🔙 Главное меню")
        markup.add(btn1)
        bot.send_message(message.from_user.id, "В Канавинском районе Вы можете посетить следущие клубы:\n\n🥂 Sexofon Club: клуб с прекрасным персоналом и приятной атмосферой. С более подробной информацией можете ознакомиться перейдя по [ссылке](https://vk.com/sexofon_nn)."
        ...
        markup.add(btn1, btn2, btn3)
        bot.send_message(message.from_user.id,
                 "🥂 В Ленинском районе, к сожалению, нет клубов, но Вы можете потусить в любом другом районе Нижнего Новгорода из предложенного ниже списка.", reply_markup=markup)
        ...
        markup.add(btn1, btn2, btn3)
        bot.send_message(message.from_user.id,
                 "🥂 В Автозаводском районе, к сожалению, нет клубов, но Вы можете потусить в любом другом районе Нижнего Новгорода из предложенного ниже списка.", reply_markup=markup)
